...
$(document).ready(function (e) {
	var popupExt = {
		...
		changeTheme: function() {
			$(".whatruns-dark").click(function () {
				localStorage.setItem("theme", "dark");
				popupExt.applyTheme();
			})
			$(".whatruns-white").click(function () {
		...
		applyBrowserTheme: function () {
			var browserTheme = window.matchMedia("(prefers-color-scheme: dark)").matches ? "dark" : "light";
			 if ( browserTheme ==="dark") {
				...
				$(".whatruns-dark").removeClass('show')
				$(".whatruns-white").addClass('show')
			}
		},
		applyTheme: function() {
			...
			if(theme === "dark") {
				...
				$(".whatruns-dark").addClass('show')
				$(".whatruns-white").removeClass('show')
			} else {
				document.body.classList.remove("whatruns-dark-mode");
				$(".whatruns-dark").addClass('show')
				$(".whatruns-white").removeClass('show')
		...
		initFollowEvent: function () {
			$('.header-btn.user-follow').click(function (e) {
		...
		initShareEvent: function () {
			$('.header-btn.share-url').click(function (e) {
